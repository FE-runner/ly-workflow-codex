...
const zhCN = {
  common: {
    ...
    preflight: {
      ...
      skillsMissingCodex: 'codex 宿主缺少 opsx 编排 prompt——运行 openspec init --tools codex 生成 ~/.codex/prompts/opsx-*.md',
    },
    doctor: {
  ...
  menu: {
    ...
    help: {
      title: '已安装命令:',
      hint: '用 /ly:propose 描述需求生成方案，/ly:apply 实施。更多信息: lycx --help',
    },
    uninstall: {
      globalDetected: '检测到你是通过 npm 全局安装的',
      twoSteps: '完整卸载需要两步：',
      ...
      confirm: '确定要卸载 ly-workflow-codex 吗？将移除 ~/.codex/prompts/ly-*.md 与共享角色词 ~/.ly/prompts/codex/；共享配置 ~/.ly/config.toml 与 ~/.ly/ 其余内容（含 worktrees）保留。',
      uninstalling: '正在卸载...',
      success: '工作流文件已移除',
      removedCodexPrompts: '已移除 codex 宿主命令:',
...
const en: typeof zhCN = {
  common: {
    ...
    preflight: {
      ...
      skillsMissingCodex: 'codex host is missing the opsx custom prompts — run openspec init --tools codex to generate ~/.codex/prompts/opsx-*.md',
    },
    doctor: {
  ...
  menu: {
    ...
    help: {
      ...
      hint: 'Use /ly:propose to describe a requirement and /ly:apply to implement. More info: lycx --help',
    },
    uninstall: {
      globalDetected: 'Detected npm global installation',
      ...
      confirm: 'Uninstall ly-workflow-codex? This removes ~/.codex/prompts/ly-*.md and shared prompts (~/.ly/prompts/codex/); shared config ~/.ly/config.toml and the rest of ~/.ly/ (incl. worktrees) are kept.',
      uninstalling: 'Uninstalling...',
      success: 'Workflow files removed',
      removedCodexPrompts: 'Removed codex host commands:',
