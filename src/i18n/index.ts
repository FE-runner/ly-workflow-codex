...
const zhCN = {
  ...
  menu: {
    ...
    uninstall: {
      ...
      worktreesKept: '检测到未清理的 worktree（~/.codex/lyx/worktrees/），已保留该目录，请先运行 `lycx worktree remove` 清理后再手动删除。',
      cancelled: '卸载已取消',
      failed: '卸载失败',
...
const en: typeof zhCN = {
  ...
  menu: {
    ...
    uninstall: {
      ...
      worktreesKept: 'Worktrees (~/.codex/lyx/worktrees/) kept: a live git worktree was detected — run `lycx worktree remove` first, then delete manually.',
