...
const zhCN = {
  ...
  init: {
    ...
    summary: {
      ...
      reviewReasoningEffort: '审查推理档',
      codingReasoningEffort: 'coding 推理档',
      reasoningUnset: '未覆盖（继承模型/宿主默认）',
      reasoningConfigured: '已覆盖: {{value}}',
      reasoningIneffective: '{{value}}（主 agent 执行时不生效）',
      reasoningIneffectiveUnset: '主 agent 执行时不生效（未覆盖）',
      workflows: '工作流:',
      commandCount: '命令数量',
    },
    model: {
    ...
    reasoning: {
      reviewLabel: '审查推理档（reviewReasoningEffort）',
      codingLabel: 'coding 推理档（codingReasoningEffort）',
      unsetChoice: '不覆盖（继承模型/宿主默认）',
      customChoice: '自定义输入档位…',
      customPrompt: '输入推理档（留空 = 不覆盖；取值不做枚举强校验）',
    },
  },
  doctor: {
    modelConfig: {
      ...
      okReasoningConfigured: '{{key}}={{effort}}（已覆盖，仅展示，不做枚举强校验）',
      okReasoningUnset: '{{key}} 未覆盖（继承模型/宿主默认）',
...
const en: typeof zhCN = {
  ...
  init: {
    ...
    summary: {
      ...
      reviewReasoningEffort: 'Review reasoning effort',
      codingReasoningEffort: 'Coding reasoning effort',
      reasoningUnset: 'not overridden (inherit model/host default)',
      reasoningConfigured: 'overridden: {{value}}',
      reasoningIneffective: '{{value}} (has no effect when the main agent executes)',
      reasoningIneffectiveUnset: 'has no effect when the main agent executes (not overridden)',
      workflows: 'Workflows:',
    ...
    reasoning: {
      reviewLabel: 'Review reasoning effort (reviewReasoningEffort)',
      codingLabel: 'Coding reasoning effort (codingReasoningEffort)',
      unsetChoice: 'Do not override (inherit model/host default)',
      customChoice: 'Custom effort input…',
      customPrompt: 'Enter a reasoning effort (empty = do not override; values are not enum-validated)',
    },
  },
  doctor: {
    modelConfig: {
      ...
      okReasoningConfigured: '{{key}}={{effort}} (overridden, display only, no enum validation)',
      okReasoningUnset: '{{key}} not overridden (inherits model/host default)',
